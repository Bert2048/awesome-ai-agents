...
- [Mastra](https://github.com/mastra-ai/mastra): A performant, opinionated TypeScript framework for building scalable AI features and workflows. ![GitHub Repo stars](https://img.shields.io/github/stars/mastra-ai/mastra?style=social) ![TypeScript](https://img.shields.io/badge/TypeScript-blue?logo=typescript&logoColor=white)
- [Swarm](https://github.com/openai/swarm): An experimental, lightweight orchestration framework for exploring ergonomics in multi-agent systems. ![GitHub Repo stars](https://img.shields.io/github/stars/openai/swarm?style=social) ![Python](https://img.shields.io/badge/Python-blue?logo=python&logoColor=white)
- [AgentScope](https://github.com/modelscope/agentscope): A user-friendly framework for building multi-agent systems with a focus on developer efficiency. ![GitHub Repo stars](https://img.shields.io/github/stars/modelscope/agentscope?style=social) ![Python](https://img.shields.io/badge/Python-blue?logo=python&logoColor=white)
- [Botpress](https://github.com/botpress/botpress): A platform provides the core infrastructure for building and deploying robust chatbots. ![GitHub Repo stars](https://img.shields.io/github/stars/botpress/botpress?style=social) ![TypeScript](https://img.shields.io/badge/TypeScript-blue?logo=typescript&logoColor=white)
- [Upsonic](https://github.com/upsonic/upsonic): A reliable agent framework with native support for the Model Context Protocol (MCP). ![GitHub Repo stars](https://img.shields.io/github/stars/upsonic/upsonic?style=social) ![TypeScript](https://img.shields.io/badge/TypeScript-blue?logo=typescript&logoColor=white)
- [VoltAgent](https://github.com/VoltAgent/voltagent): A TypeScript framework for autonomous agents featuring built-in observability and debugging. ![GitHub Repo stars](https://img.shields.io/github/stars/voltagent/voltagent?style=social) ![TypeScript](https://img.shields.io/badge/TypeScript-blue?logo=typescript&logoColor=white)
- [Swarms Framework](https://github.com/kyegomez/swarms): An enterprise-ready multi-agent orchestration system for complex mission-critical applications. ![GitHub Repo stars](https://img.shields.io/github/stars/kyegomez/swarms?style=social) ![Python](https://img.shields.io/badge/Python-blue?logo=python&logoColor=white)
- [PraisonAI](https://github.com/MervinPraison/PraisonAI): A low-code multi-agent framework emphasizing rapid instantiation and MCP support. ![GitHub Repo stars](https://img.shields.io/github/stars/MervinPraison/PraisonAI?style=social) ![Python](https://img.shields.io/badge/Python-blue?logo=python&logoColor=white)
- [Strands Agents SDK](https://github.com/strands-agents/sdk-python): A model-driven SDK for building agentic behaviors with minimal boilerplate code. ![GitHub Repo stars](https://img.shields.io/github/stars/strands-agents/sdk-python?style=social) ![Python](https://img.shields.io/badge/Python-blue?logo=python&logoColor=white)
